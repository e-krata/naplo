...
for (int i = 5; i > 1; i--) {
  ...
  if (count > 4) {
    ...
    gradeWidgets.addAll(
      List.generate(count, (_) => GradeDisplay(grade: i)),
    );
  }
...
return Padding(
  ...
  child: SizedBox(
    ...
    child: Card(
      surfaceTintColor:
          selected ? markColor().withOpacity(.2) : Colors.white,
            ...
            children: [
              if (mark != null) ...[
                Chip(
                  ...
                  backgroundColor:
                      selected ? markColor() : Colors.transparent,
                  labelPadding:
