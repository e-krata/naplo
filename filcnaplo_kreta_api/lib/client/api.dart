...
BaseKreta.kretaIdp + KretaApiEndpoints.token;

static String get logout =>
BaseKreta.kretaIdp + KretaApiEndpoints.revoke;

static String get nonce =>
BaseKreta.kretaIdp + KretaApiEndpoints.nonceEndpoint;

static const clientId = "filc-ellenorzo-mobile-hivatalos";
...
static String get kretaIdp =>
baseUrl.replaceAll(RegExp(r'/+$'), '');

static String get kretaAdmin =>
baseUrl.replaceAll(RegExp(r'/+$'), '');

static String get kretaFiles =>
baseUrl.replaceAll(RegExp(r'/+$'), '');
}
...
"/api/v1/kreta/alkalmazottak/igazgatasag";
